...
#
# # 2. Load your generator
# G_content2style = Datasets.GeneratorResNet()
# G_content2style.load_state_dict(torch.load("G_content2style_15.pth", map_location="cpu"))
...
# #    (Here we assume .jpg images; add more patterns for .png, .jpeg, etc.)
